...
const backupRoot = path.join(
  projectRoot,
  ".aydemir-backups",
  `presentation-card-v2-${timestamp}`,
);
...
const cssPatch = fs.readFileSync(
  path.join(
    __dirname,
    "presentation-card-clean-premium.css",
  ),
  "utf8",
);

const marker =
  "AYDEMIR V2 PRESENTATION CARD CLEAN PREMIUM V2";
...
console.log("");
console.log(
  "AYDEMİR SUNUM KARTLARI SADE PREMIUM GÜNCELLEMESİ TAMAMLANDI.",
);
