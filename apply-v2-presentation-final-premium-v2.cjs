...
const backupRoot = path.join(
  projectRoot,
  ".aydemir-backups",
  `presentation-final-premium-v2-${timestamp}`,
);
...
const cssPatch = fs.readFileSync(
  path.join(
    __dirname,
    "presentation-card-final-premium.css",
  ),
  "utf8",
);

const marker =
  "AYDEMIR V2 PRESENTATION CARD FINAL PREMIUM V2";
...
console.log("");
console.log(
  "AYDEMİR SUNUM KARTLARI FİNAL PREMIUM V2 GÜNCELLEMESİ TAMAMLANDI.",
);
