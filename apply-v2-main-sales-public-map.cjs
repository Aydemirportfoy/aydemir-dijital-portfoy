...
const cssPatch = fs.readFileSync(
  path.join(
    __dirname,
    "main-sales-public-map.css",
  ),
  "utf8",
);

const marker =
  "AYDEMIR V2 MAIN SALES + PUBLIC NEIGHBORHOOD MAP";
...
console.log("");
console.log(
  "AYDEMİR SATIŞ ROZETLERİ VE MAHALLE KONUMU GÜNCELLEMESİ TAMAMLANDI.",
);
