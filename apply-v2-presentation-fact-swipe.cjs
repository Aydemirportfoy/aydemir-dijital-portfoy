...
const cssPatch = fs.readFileSync(
  path.join(
    __dirname,
    "presentation-fact-swipe.css",
  ),
  "utf8",
);

const marker =
  "AYDEMIR V2 PRESENTATION FACT TEXT + PREMIUM SWIPE";
...
console.log("");
console.log(
  "AYDEMİR BÜYÜK ÖZELLİK YAZILARI VE PREMIUM KART KAYDIRMA TAMAMLANDI.",
);
