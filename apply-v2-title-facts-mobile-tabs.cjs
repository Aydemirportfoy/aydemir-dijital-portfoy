...
const cssPatch = fs.readFileSync(
  path.join(
    __dirname,
    "title-facts-mobile-tabs.css",
  ),
  "utf8",
);

const marker =
  "AYDEMIR V2 TITLE FACTS + MOBILE 3 TABS";
...
console.log("");
console.log(
  "AYDEMİR BAŞLIK ALTI BİLGİLER VE MOBİL 3 KART GÜNCELLEMESİ TAMAMLANDI.",
);
