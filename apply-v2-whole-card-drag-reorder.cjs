...
const cssPatch =
  fs.readFileSync(
    path.join(
      __dirname,
      "whole-card-drag-reorder.css",
    ),
    "utf8",
  );

const marker =
  "AYDEMIR V2 WHOLE CARD DRAG REORDER";
...
console.log("");
console.log(
  "AYDEMİR SUNUM SIRALAMASI KARTIN TAMAMINDAN SÜRÜKLENİR HALE GETİRİLDİ.",
);
