...
const cssPatch = fs.readFileSync(
  path.join(
    __dirname,
    "cards-static-photo-gallery.css",
  ),
  "utf8",
);

const marker =
  "AYDEMIR V2 CARDS STATIC + PHOTO GALLERY SWIPE";
...
console.log("");
console.log(
  "AYDEMİR SUNUM KARTLARI SABİT, FOTOĞRAFLAR KAYDIRMALI OLARAK GÜNCELLENDİ.",
);
