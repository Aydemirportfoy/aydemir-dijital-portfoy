...
const backupRoot = path.join(
  projectRoot,
  ".aydemir-backups",
  `presentation-drag-reorder-${timestamp}`,
);
...
const cssPatch =
  fs.readFileSync(
    path.join(
      __dirname,
      "presentation-drag-reorder.css",
    ),
    "utf8",
  );

const marker =
  "AYDEMIR V2 PRESENTATION DRAG REORDER";
...
console.log("");
console.log(
  "AYDEMİR SUNUM İLAN SIRASI SÜRÜKLE-BIRAK OLARAK GÜNCELLENDİ.",
);
