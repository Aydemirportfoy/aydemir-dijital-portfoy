...
const backupRoot = path.join(
  projectRoot,
  ".aydemir-backups",
  `detail-gallery-mobile-${timestamp}`,
);
...
const cssPatch =
  fs.readFileSync(
    path.join(
      __dirname,
      "detail-gallery-mobile-note.css",
    ),
    "utf8",
  );

const marker =
  "AYDEMIR V2 DETAIL GALLERY + MOBILE ALIGNMENT + NOTE";
...
console.log("");
console.log(
  "AYDEMİR DETAY GALERİSİ, MOBİL PORTFÖY HİZASI VE MÜŞTERİ NOTU GÜNCELLENDİ.",
);
